...
var UIController = (function () {
    ...
    var DOMstrings = {
     ...
     var formatNumber= function(num, type) {
        ...
        displayMonth: function {
            ...
            var now= new Date();
            months= ['January', 'Febuary', 'Mrch', 'April', 'May', 'June', 'July', 'Auguest', 'Sepember', 'October', 'November', 'December' ];
            month= now.getMonth();
    ...
    return {
        ...
        addListIem: function (obj, type) {
            ...
            newHtml = newHtml.replace('%value%', formatNumber(obj.value, type) obj.value);
...
nodel.istForEach(fields, function(current,index){
